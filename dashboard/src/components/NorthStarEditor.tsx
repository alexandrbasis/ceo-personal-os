...
export interface NorthStarEditorProps {
...
/**
 * NorthStarEditor - Rich markdown editor with formatting toolbar
 *
 * Features:
 ...
 */
export function NorthStarEditor({
  initialContent,
  onSave,
  onCancel,
}: NorthStarEditorProps) {
      ...
      {mode === 'edit' && (
        <>
          ...
          <Textarea
            ...
            aria-label="North Star content"
            className="flex-1 min-h-[400px] font-mono text-sm resize-none"
            placeholder="Write your North Star..."
          />
        </>
      )}
