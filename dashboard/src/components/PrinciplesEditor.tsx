...
export interface PrinciplesEditorProps {
...
const DRAFT_KEY = 'principlesDraft';
const DEBOUNCE_MS = 500;

/**
 * PrinciplesEditor - Rich markdown editor with formatting toolbar and auto-save
 *
 * Features:
      ...
      {mode === 'edit' && (
        <>
          ...
          <Textarea
            ...
            aria-label="Principles content"
            className="flex-1 min-h-[400px] font-mono text-sm resize-none"
            placeholder="Write your principles..."
          />
        </>
      )}
